...
import com.projects.demo.view.IphoneTreeView;
import com.projects.demo.view.IphoneTreeView.IphoneTreeHeaderAdapter;

@SuppressLint("UseSparseArrays")
public class IphoneTreeViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.iphone_tree_view_activity);
		initView();
	}
	...
	private void initView() {
		...
		iphoneTreeView.setHeaderView(getLayoutInflater().inflate(
				R.layout.iphone_tree_view_list_head_view, iphoneTreeView, false));
	...
	public class IphoneTreeViewAdapter extends BaseExpandableListAdapter
		...
		public View getChildView(int groupPosition, int childPosition,
			...
			// TODO Auto-generated method stub
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.iphone_tree_view_list_item_view, null);
			}
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			// TODO Auto-generated method stub
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.iphone_tree_view_list_group_view, null);
			}
