...
public class HallFood extends ConstantPrint {
	...
	public void print() throws AccessException {
		...
		//styles
		control.sendESC(FormatSetting_Command.getESCan((byte) 0x49)); //align center
		...
		control.printText(TAG_TYPE + TAG_TYPE_A + "\n");

		control.printText(TAG_POSITION + "\n");
