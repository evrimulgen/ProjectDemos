...
import com.projects.demo.videoplayer.SoundView.OnVolumeChangedListener;
import com.projects.demo.videoplayer.VideoView.MySizeChangeLinstener;

public class CopyOfVideoPlayerActivity extends Activity {
...
//	private ImageButton bn4 = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        controlView = getLayoutInflater().inflate(R.layout.controller1, null);
        ...
        backButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				CopyOfVideoPlayerActivity.this.finish();
			}
        ...
        aboutButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				dialog = new Dialog(CopyOfVideoPlayerActivity.this);
				dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
				View view = CopyOfVideoPlayerActivity.this.getLayoutInflater().inflate(R.layout.about, null);
...
//        bn4 = (ImageButton) controlView.findViewById(R.id.button4);
        ...
        if(uri!=null){
        	...
        	bn3.setImageResource(R.drawable.media_pause);
        }else{
        	bn3.setImageResource(R.drawable.media_play);
        }

        new Thread(new Runnable() {
			@Override
			public void run() {
				getVideoFile(playList, Environment.getExternalStorageDirectory());
			}
		}).start();
...
//        bn4.setAlpha(0xBB);
        ...
        /*bn1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				intent.setClass(CopyOfVideoPlayerActivity.this, VideoChooseActivity.class);
				CopyOfVideoPlayerActivity.this.startActivityForResult(intent, 0);
		...
		public void handleMessage(Message msg) {
			...
			switch(msg.what){
				...
				case PROGRESS_CHANGED:
					...
					Log.d("RESULT", ""+vv.getBufferPercentage());
					seekBar.setSecondaryProgress(vv.getDuration()*vv.getBufferPercentage()/100);
    	...
    	file.listFiles(new FileFilter(){
			...
			public boolean accept(File file) {
				...
				if(i != -1){
					...
					if(name.equalsIgnoreCase(".mp4")||name.equalsIgnoreCase(".3gp")||name.equalsIgnoreCase(".mp3")){
						MovieInfo mi = new MovieInfo();
						mi.displayName = file.getName();
						mi.path = file.getAbsolutePath();
						list.add(mi);
						Log.d(TAG, "file.name = " + mi.displayName);
						return true;
					}
