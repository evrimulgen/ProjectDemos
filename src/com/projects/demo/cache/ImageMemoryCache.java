...
/**
 * image memory cache.
 * this class includes memory image cache.
...
public class ImageMemoryCache {
    ...
    /**
     * get bitmap from imageMemoryCache that include sHardBitmapCache and sSoftBitmapCache.
    ...
    private int getHardSize() {
    	return sHardBitmapCache.size();
    }
    
    private int getSoftSize() {
    	return sSoftBitmapCache.size();
    }
